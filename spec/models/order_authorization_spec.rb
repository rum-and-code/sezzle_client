...
# Unit tests for SwaggerClient::OrderAuthorization
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OrderAuthorization' do
  before do
    # run before each test
    @instance = SwaggerClient::OrderAuthorization.new
  end
  ...
  describe 'test an instance of OrderAuthorization' do
    it 'should create an instance of OrderAuthorization' do
      expect(@instance).to be_instance_of(SwaggerClient::OrderAuthorization)
    end
  end
