...
# Unit tests for SezzleClient::Body4
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Body4' do
  before do
    # run before each test
    @instance = SezzleClient::Body4.new
  end
  ...
  describe 'test an instance of Body4' do
    it 'should create an instance of Body4' do
      expect(@instance).to be_instance_of(SezzleClient::Body4)
    end
  end
  ...
  describe 'test attribute "upcharge_amount"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
