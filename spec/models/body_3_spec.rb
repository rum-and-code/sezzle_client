...
# Unit tests for SezzleClient::Body3
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Body3' do
  before do
    # run before each test
    @instance = SezzleClient::Body3.new
  end
  ...
  describe 'test an instance of Body3' do
    it 'should create an instance of Body3' do
      expect(@instance).to be_instance_of(SezzleClient::Body3)
    end
  end
  ...
  describe 'test attribute "partial_capture"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
